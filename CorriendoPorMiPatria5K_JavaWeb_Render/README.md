...
## Cerrar o abrir inscripciones sin borrar participantes
La aplicación soporta la variable de entorno `REGISTRATION_OPEN`.

- `REGISTRATION_OPEN=false`: bloquea GET y POST de `/inscripcion`, muestra "INSCRIPCIONES CERRADAS" y mantiene `/admin` operativo.
- `REGISTRATION_OPEN=true`: vuelve a habilitar la inscripción.

Los participantes existentes permanecen en PostgreSQL/Neon en ambos casos.
